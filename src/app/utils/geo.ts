 ...
 */
export const simplifyTrack = (points: Point[], epsilon: number): Point[] => {
 ...
 */
export const filterJitter = (points: Point[], minDistance: number): Point[] => {
 ...
 */
export const detectTurns = (points: Point[]): Instruction[] => {
